...
class BuildingForDisplayLoader:
	...
	def set_address_description(language, building):
		print('full address')
		building.full_address = BuildingForDisplayLoader.get_building_full_address(language, building)
		print('alias name')
	...
	@staticmethod
	def get_building_full_address(language, building):
		lane = BuildingForDisplayLoader._get_lane(language, building.id_lane)
